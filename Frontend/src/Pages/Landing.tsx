    ...
    <div className="min-h-screen  text-black">
      <div className="flex flex-col items-center justify-center mt-25 px-4">
        ...
        <div className="w-full max-w-md border border-black p-6 rounded-xl flex flex-col gap-4 items-center">
          ...
          />
          <button className="w-full bg-zinc-700  text-white py-2 rounded-md hover:opacity-80 transition">
            Join Room
          </button>
          ...
          <button className="w-full border border-black py-2  hover:opacity-80 transition rounded-md hover: bg-zinc-700 text-white transition">
            Create a New Room
          </button>
        </div>
      </div>
